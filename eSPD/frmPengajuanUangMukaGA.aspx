<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="frmPengajuanUangMukaGA.aspx.cs" Inherits="eSPD.frmPengajuanUangMukaGA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel5" runat="server">
        <table style="width: 100%;">
            ...
            <tr>
                <td colspan="2">
                    <asp:GridView ID="grvList" runat="server" AutoGenerateColumns="False" AllowPaging="True"
