    ...
    public static class EmailCore
    {
          ...
          string indexLevel)
        {
            using (dsSPDDataContext ctx = new dsSPDDataContext())
            {
                ...
                {
                    ccAddress = "erna.stafitri@sera.astra.co.id,stefanie@sera.astra.co.id,YUDAS.TADEUS@SERA.ASTRA.CO.ID";
               ...
               //     toAddress = "yudas.tadeus@sera.astra.co.id";
               ...
               //}
                ...
                {
                    bccAddress = "espddeveloper@gmail.com,";
                ...
                else { bccAddress = "espddeveloper@gmail.com"; }
