    ...
    public class classSpd
    {
        ...
        internal void sendMail(trSPD spd, string To, msKaryawan kar)
        {
            ...
            if (spd.status.Split('-')[0] == "2")
            {
                ...
                emailMessage.Append("<br />");
                emailMessage.Append(string.Format("<a href='http://trac39/SPD/approvalSPD.ashx?conf=approve&nospd={0}&subject={1}&type={2}'>Approve</a>", spd.noSPD, "atasan", "spd"));
                emailMessage.Append(" ");
                emailMessage.Append("|");
                emailMessage.Append(" ");
                emailMessage.Append(string.Format("<a href='http://trac39/SPD/approvalSPD.ashx?conf=reject&nospd={0}&subject={1}&type={2}'>Reject</a>", spd.noSPD, "atasan", "spd"));
                emailMessage.Append("<br />");
                emailMessage.Append("<br />");
            ...
            else if ((spd.status.Split('-')[0] == "3" || spd.status.Split('-')[0] == "6") && To == "Tujuan")
            {
                ...
                emailMessage.Append("Apabila Bapak/ Ibu berada di kantor bisa menggunakan link dibawah ini untuk melakukan approve/reject Request Claim SPD tersebut");
                emailMessage.Append("<br />");
                emailMessage.Append(string.Format("<a href='http://trac39/SPD/approvalSPD.ashx?conf=approve&nospd={0}&subject={1}&type={2}'>Approve</a>", spd.noSPD, "tujuan", "spd"));
                emailMessage.Append(" ");
                emailMessage.Append("|");
                emailMessage.Append(" ");
                emailMessage.Append(string.Format("<a href='http://trac39/SPD/approvalSPD.ashx?conf=reject&nospd={0}&subject={1}&type={2}'>Reject</a>", spd.noSPD, "tujuan", "spd"));
                emailMessage.Append("<br />");
                emailMessage.Append("<br />");
                emailMessage.Append("Apabila Bapak/ Ibu berada di luar kantor bisa menggunakan link dibawah ini ");
                emailMessage.Append("<br />");
            ...
            else if (spd.status.Split('-')[0] == "11")
            {
                ...
                emailMessage.Append("Apabila Bapak/ Ibu berada di kantor bisa menggunakan link dibawah ini untuk melakukan approve/reject Request Claim SPD tersebut");
                emailMessage.Append("<br />");
                emailMessage.Append(string.Format("<a href='http://trac39/SPD/approvalSPD.ashx?conf=approve&nospd={0}&subject={1}&type={2}'>Approve</a>", spd.noSPD, "atasan", "claim"));
                emailMessage.Append(" ");
                emailMessage.Append("|");
                emailMessage.Append(" ");
                emailMessage.Append(string.Format("<a href='http://trac39/SPD/approvalSPD.ashx?conf=reject&nospd={0}&subject={1}&type={2}'>Reject</a>", spd.noSPD, "atasan", "claim"));
                emailMessage.Append("<br />");
                emailMessage.Append("<br />");
                emailMessage.Append("Apabila Bapak/ Ibu berada di luar kantor bisa menggunakan link dibawah ini ");
                emailMessage.Append("<br />");
            ...
            else if ((spd.status.Split('-')[0] == "16") && To == "GA")
            {
                ...
                emailMessage.Append("Apabila Bapak/ Ibu berada di kantor bisa menggunakan link dibawah ini untuk melakukan approve/reject Request Claim SPD tersebut");
                emailMessage.Append("<br />");
                emailMessage.Append(string.Format("<a href='http://trac39/SPD/approvalSPD.ashx?conf=approve&nospd={0}&subject={1}&type={2}'>Approve</a>", spd.noSPD, "ga", "claim"));
                emailMessage.Append(" ");
                emailMessage.Append("|");
                emailMessage.Append(" ");
                emailMessage.Append(string.Format("<a href='http://trac39/SPD/approvalSPD.ashx?conf=reject&nospd={0}&subject={1}&type={2}'>Reject</a>", spd.noSPD, "ga", "claim"));
                emailMessage.Append("<br />");
                emailMessage.Append("<br />");
                emailMessage.Append("Apabila Bapak/ Ibu berada di luar kantor bisa menggunakan link dibawah ini ");
                emailMessage.Append("<br />");
            ...
            else if ((spd.status.Split('-')[0] == "17") && To == "finance")
            {
                ...
                emailMessage.Append("Apabila Bapak/ Ibu berada di kantor bisa menggunakan link dibawah ini untuk melakukan approve/reject Request Claim SPD tersebut");
                emailMessage.Append("<br />");
                emailMessage.Append(string.Format("<a href='http://trac39/SPD/approvalSPD.ashx?conf=approve&nospd={0}&subject={1}&type={2}'>Approve</a>", spd.noSPD, "finance", "claim"));
                emailMessage.Append(" ");
                emailMessage.Append("|");
                emailMessage.Append(" ");
                emailMessage.Append(string.Format("<a href='http://trac39/SPD/approvalSPD.ashx?conf=reject&nospd={0}&subject={1}&type={2}'>Reject</a>", spd.noSPD, "finance", "claim"));
                emailMessage.Append("<br />");
                emailMessage.Append("<br />");
                emailMessage.Append("Apabila Bapak/ Ibu berada di luar kantor bisa menggunakan link dibawah ini ");
                emailMessage.Append("<br />");
            ...
            email.From = new System.Net.Mail.MailAddress("adminsps@sera.astra.co.id");
