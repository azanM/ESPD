<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="frmMsPlafon.aspx.cs" Inherits="eSPD.frmMsPlafon" %>
                        ...
                        <asp:Panel ID="pnlForm" runat="server" Visible="false">
                            <table width="auto" align="left">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtNrp" runat="server" AutoPostBack="true" ></asp:TextBox>
                                        <%--<asp:Label ID="lblCostDesc" runat="server" ForeColor="#CC0000" Text="*"></asp:Label>--%>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Plafon Tidak boleh kosong"
                        ...
                        <asp:Panel ID="pnlGrid" runat="server" Visible="true">
                            ...
                            <asp:GridView ID="gvRole" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="plafon" HeaderText="Plafon" />
