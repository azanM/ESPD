...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="spdApproval" runat="server">
        <h3><asp:Literal ID="header" runat="server"></asp:Literal> 
        <span>
        ...
        <asp:UpdatePanel ID="UpApprovalSPD" runat="server">
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" Width="200px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AutoPostBack="true">
                ...
                <asp:ListItem Text="BPH UM" Value="BPHUM"></asp:ListItem>
                <asp:ListItem Text="Error BPH UM" Value="ErrorBPHUM"></asp:ListItem>
            </asp:DropDownList>
                    &nbsp;&nbsp;&nbsp;&nbsp;
              <asp:TextBox ID="txtcari" runat="server" Visible="false"></asp:TextBox>
                ...
                <div style="border: 1px solid #e3e3e3">
                    <asp:GridView ID="ViewADH" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="NRP" DataField="" />
                            <asp:BoundField HeaderText="Nama Lengkap" DataField="" />
                            <asp:BoundField HeaderText="Sisa Budget" DataField="" />
                            <asp:BoundField HeaderText="Biaya Actual" DataField="" />
                        </Columns>
                    </asp:GridView>
                </div>
                ...
                <div style="border: 1px solid #e3e3e3">
                    <asp:GridView ID="gvViewSPD" runat="server" AutoGenerateColumns="False"
                        ...
                        OnRowDataBound="gvViewSPD_RowDataBound">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="BPH UM" DataField="BPHUM" />
                            <asp:BoundField HeaderText="Error BPH UM" DataField="errorBPHUM" />
    ...
    <div id="ClaimAtasan" runat="server">
        <h3>List Claim Approval Atasan</h3>
        <div style="border: 1px solid #e3e3e3">
            <asp:GridView ID="gvAtasan" runat="server" AutoGenerateColumns="False"
                ...
                OnRowDataBound="gvAtasan_RowDataBound"
