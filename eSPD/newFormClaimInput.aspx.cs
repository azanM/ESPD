...
namespace eSPD
{
    public partial class newFormClaimInput : System.Web.UI.Page
    {
        ...
        protected void HideResult(bool p)
        {
            ...
            Tunjangankejauhan.Visible = p; //update 9 Oktober 2018
        }
        ...
        protected void GeneralFunction(object sender, EventArgs e)
        {
            ...
            if (String.IsNullOrEmpty(txtTunjanganKejauhan.Text)) txtTunjanganKejauhan.Text = "0"; //9 oktober 2018
            ...
            var tunjanganKejauhan = Convert.ToInt32(txtTunjanganKejauhan.Text);// 9 oktober 2018 
            var total =
                uangMakan +
                uangSaku +
                tiket +
            ...
            Tunjangankejauhan.Text = (tunjanganKejauhan * kursInt).ToString();// 9  oktober 2018
        ...
        protected void cbBiayaHotel_OnCheckedChanged(object sender, EventArgs e)
        {
            CheckBox cBox = (sender as CheckBox);
            if (cBox.Checked)
            {
                cbHotelTanpaPenginapan.Enabled = false;
            }
            else
            {
                cbHotelTanpaPenginapan.Enabled = true;
            }
        }

        protected void cbTanpaPenginapan_OnCheckedChanged(object sender, EventArgs e)
        {
            CheckBox cBox = (sender as CheckBox);
            if (cBox.Checked)
            {
