                        ...
                        <table class="gridtable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox ID="cbUangSaku" runat="server" Visible="false" />
                                ...
                                <tr>
                                    <td>Tiket (Pesawat, KA, Kapal/Fery, Travel, dan alat transportasi lainnya)</td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <table class="gridtable" style="align-content:center">
                                            <tr>
                                            <td><asp:CheckBox ID="cbHotel" runat="server" AutoPostBack="true" OnCheckedChanged="cbBiayaHotel_OnCheckedChanged" Text="Biaya Hotel" TextAlign="Left" Visible="false"/></td>
                                            <td rowspan="2">
                                            <asp:TextBox ID="txtHotel" runat="server" AutoPostBack="True" OnTextChanged="GeneralFunction">0</asp:TextBox>
                                            </td>
                                            </tr>
                                            <tr>
                                                <td><asp:CheckBox ID="cbHotelTanpaPenginapan" AutoPostBack="true" OnCheckedChanged="cbTanpaPenginapan_OnCheckedChanged"  Text="Tanpa Penginapan" TextAlign="Left" runat="server" Visible="false"/></td>
                                            </tr>
                                            <tr>
                                                ...
                                                <asp:TextBox ID="Hotel" Visible="true" runat="server" ReadOnly="True" Text="0"></asp:TextBox>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>Tunjangan Kejauhan</td>
                                    <td>
                                        <asp:TextBox ID="txtTunjanganKejauhan" runat="server" OnTextChanged="GeneralFunction"
                                            AutoPostBack="True" ReadOnly="true">0</asp:TextBox>
                                        <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server"
                                            Enabled="True" ValidChars="1234567890" FilterType="Custom" TargetControlID="txtTunjanganKejauhan">
                                        </asp:FilteredTextBoxExtender>
                                        <asp:TextBox ID="Tunjangankejauhan" runat="server" ReadOnly="True" Text="0"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Biaya Lain-lain
                                ...
                                <tr>
                                    <td>Upload Form Lampiran Claim</td>
                                    <td>
                                        ...
                                        <asp:UpdatePanel runat="server" ID="updatepanel1">
                                            ...
                                            <ContentTemplate>
                                                <asp:FileUpload ID="fuDoc" runat="server" Enabled="false" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <asp:UpdatePanel runat="server" ID="updatepanel2">
                                            ...
                                            <ContentTemplate>
                                                <asp:FileUpload ID="fuDoc1" runat="server" Enabled="false" />
                                            </ContentTemplate>
                                        </asp:UpdatePanel>
                                    </td>
                                </tr>
