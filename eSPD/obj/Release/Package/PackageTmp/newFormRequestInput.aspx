            ...
            <dl class="dl-horizontal">
                ...
                <dd>
                    <asp:DropDownList
                        ...
                        DataValueField="Golongan" Enabled="false">
                    </asp:DropDownList>
                    <asp:DropDownList
                        ID="ddlSubGolongan"
                        runat="server"
                        AutoPostBack="True" Visible ="false"
                        AppendDataBoundItems="True"  OnSelectedIndexChanged="ddlSubGolongan_SelectedIndexChanged">
        ...
        <div class="panel-body">
            <dl class="dl-horizontal">
                ...
                <dd>
                    ...
                    </asp:DropDownList> <asp:Label ID="LblPersonalAreaTujuan" Visible="false" runat="server" Text="Harus dipilih"></asp:Label>
                    <asp:LinqDataSource
                        ID="LinqCabang"
                        runat="server"
                        ContextTypeName="eSPD.dsSPDDataContext"
                        ...
                        GroupBy="kodePA"
                        OrderGroupsBy="key"
                        Select="new (key as kodePA, it as msKaryawans, Min(personelArea) as leasingRental)"
                        TableName="msKaryawans" Where="coCd == @coCd">
                        <WhereParameters>
                ...
                <dd>
                    ...
                    <%--<asp:DropDownList
                        ...
                        DataValueField="kodePSubArea"
                        AutoPostBack="true"
                        OnSelectedIndexChanged="ddlApprovalTujuan_SelectedIndexChanged">
                    </asp:DropDownList>--%>
                    ...
                    <asp:LinqDataSource
                        ...
                        OrderGroupsBy="key"
                        Select="new (key as kodePSubArea, it as msKaryawans, Max(pSubArea) as pSubArea)"
                        TableName="msKaryawans" Where="kodePA == @kodePA">
                        <WhereParameters>
                ...
                <dd>
                    <asp:DropDownList
                        ...
                        AppendDataBoundItems="true">
                        <asp:ListItem Text=" - Select One -" Value=""></asp:ListItem>
                    </asp:DropDownList><asp:Label ID="LblKeperluan" Visible="false" runat="server" Text="Harus dipilih"></asp:Label>
                    <asp:LinqDataSource
                        ID="LinqKeperluan"
                        runat="server"
                        ContextTypeName="eSPD.dsSPDDataContext"
                ...
                <dd>
                    <asp:TextBox
                        ...
                        Width="200"
                        CssClass="calenderJQ"></asp:TextBox>
                    <%--<ajax:CalendarExtender ID="txtTglBerangkat_CalendarExtender" runat="server" PopupButtonID="txtTglBerangkat" TargetControlID="txtTglBerangkat" Format="dd/MM/yyyy">
                ...
                <dd>
                    <asp:TextBox ID="txtTglKembali" runat="server"
                        AutoPostBack="True" OnTextChanged="txtTglKembali_TextChanged" Width="200" CssClass="calenderJQ"></asp:TextBox>
                  <%--  <ajax:CalendarExtender ID="txtTglKembali_CalendarExtender" runat="server" PopupButtonID="imgPopup" TargetControlID="txtTglKembali">
                    </ajax:CalendarExtender>--%>
                    &nbsp; Jam
                ...
                <dd>
                    <ul>
                        <asp:Label ID="LblTglBerangkat" Visible="false" runat="server" Text="Tanggal berangkat harus dipilih"></asp:Label>
                        <asp:Label ID="LblTglKembali" Visible="false" runat="server" Text="Tanggal kembali harus dipilih"></asp:Label>
                        <asp:RequiredFieldValidator
                            ID="rvTglBerangkat"
                            runat="server"
                        ...
                        <asp:Label ID="lblDateLessThan" runat="server" Visible="false"> <li>
                         ...
                         <asp:Label ID="lblGoLive" runat="server" Visible="false"> <li>
                                <b>Tangal berangkat tidak boleh kurang dari tanggal 22 Desember 2017.</b> </li></asp:Label>

                        <asp:Label ID="lblBackDate" runat="server" Visible="false"> <li>
                                <b>Tanggal tidak boleh lebih kecil dari tanggal hari ini.</b> </li></asp:Label>
                        <li>
            ...
            <dl class="dl-horizontal">
                ...
                <dd>
                    <asp:DropDownList 
                        ID="listProvinsi" 
                        runat="server" 
                        OnSelectedIndexChanged="provinsi_SelectedIndexChanged" 
                        AutoPostBack="true" 
                        DataValueField="Id" 
                        DataTextField="Propinsi" AppendDataBoundItems="true" >
                ...
                <dd>
                    <asp:DropDownList 
                        ID="listLokasiProvinsi" 
                        runat="server" 
                        AutoPostBack="true"
                        OnSelectedIndexChanged="lokasi_SelectedIndexChanged">
                    </asp:DropDownList>
                </dd>

                <dt>Harga</dt>
                <dd>
                    <asp:TextBox runat="server" MaxLength="50" ReadOnly="true" ID="txtHarga"></asp:TextBox>
                </dd>
            </dl>
        </div>
    </div>
            ...
            <dl class="dl-horizontal">
                ...
                <dd>
                    <asp:DropDownList
                        ...
                        <asp:ListItem Text=" - Select One -" Value=""></asp:ListItem>
                    </asp:DropDownList><asp:Label ID="LblAngkutan" Visible="false" runat="server" Text="Harus dipilih"></asp:Label>
        ...
        <div class="panel-body">
            <dl class="dl-horizontal">
                ...
                <dd style="margin-top:10px;">
                    <span id="approvalADH"></span>
                </dd>
                <dd>
                    <asp:DropDownList
                        ID="ddlApprovalADH"
                        runat="server"
                        CssClass="cssDdlApprovalTujuan">
                    ...
                    <asp:RequiredFieldValidator
                        ID="rvApprovalADH"
                        runat="server"
                        ControlToValidate="ddlApprovalADH"
                        ErrorMessage=" Harus dipilih "
                        Font-Bold="True"
                        SetFocusOnError="True"></asp:RequiredFieldValidator>
                </dd>
                ...
                <dd>
                    ...
                    <asp:Label ID="LblApprovalTujuan" runat="server" Text="Harus dipilih" Visible="false"></asp:Label>
                    <%--<asp:LinqDataSource
                    ...
                    <%--<asp:DropDownList
                        ...
                        CssClass="cssDdlApprovalTujuan">
                        <asp:ListItem Text=" - Select One -" Value=""></asp:ListItem>
                    </asp:DropDownList><asp:Label ID="LblApprovalTujuan" runat="server" Text="Harus dipilih" Visible="false"></asp:Label>--%>
                    <%-- =================== try TO DO OrgUnit UnCommand =================== end --%>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('.ddlAtasan').each(function () {
                var tujuan = $('.ddlTujuan option:selected').text();
                $(this).select2({
                    width: 'resolve',
                ...
                $(this).select2({
                    ...
                    ajax: {
                        ...
                        data: function (bond, page) {
                            ...
                            if (index > 0) {
                                index--;
                                refNrp = $('[data-index="' + index + '"]').val();
                                refPos = $('[data-index-desc="' + index + '"]').val();
                            }
            ...
            $('.ddlAtasan').change(function () {
                var index = $(this).data('index');
                var company = $('.ddlCompanyTujuan option:selected').val();
                if (index == '0' && company == '0') {
                    $('#approvalTujuan').text($(this).select2('data').text);
                    $('#approvalTujuan').show();

                    $('.cssDdlApprovalTujuan').hide();
                }
                else if (company != '0') {
                    if ($('.cssDdlApprovalTujuan').css('display') == 'none') {
                        $('.cssDdlApprovalTujuan').show();
                    }
                }
            });

            //$('.ddlCompanyTujuan').change(function () {
            //    bindApprovalTujuan();
            //});

            function bindApprovalTujuan() {
                var index = $('[data-index="0"]').data('index');
                var company = $('.ddlCompanyTujuan option:selected').val();
                if (index == '0' && company == '0') {
                    $('#approvalTujuan').text($('[data-index="0"]').select2('data').text);
                    $('#approvalTujuan').show();
