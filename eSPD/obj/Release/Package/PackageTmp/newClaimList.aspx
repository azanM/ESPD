...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
            ...
            <div id="ClaimGA" runat="server">
                <h3>List Approval GA
                        <span>
                            ...
                            <asp:DropDownList ID="listClaimStatus" runat="server" Visible="false">
                                <asp:ListItem Selected="True" Text="--Select--" Value="--Select--"></asp:ListItem>
                            </asp:DropDownList>
                ...
                <div style="border: 1px solid #e3e3e3">
                    <asp:GridView ID="gvGA" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Form Lampiran Claim1">
                                            <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Form Lampiran Claim2">
                                            <ItemTemplate>
                            ...
                            <asp:BoundField HeaderText="BPH Claim" DataField="BPHClaim"></asp:BoundField>
                            <asp:BoundField HeaderText="Error BPH Claim" DataField="errorBPHClaim"></asp:BoundField>
                            <asp:TemplateField ItemStyle-CssClass="fright" ControlStyle-Width="60" ItemStyle-Width="130">
                                <ItemTemplate>
                                    ...
                                    <asp:Button ID="btnEdit" runat="server"
                                        ...
                                        CommandArgument='<%# Eval("noSPD") %>'
                                        Text="Edit" />
                                    <asp:Button ID="btnComplete" runat="server" Font-Size="8"
                                        CommandName="Complete" Visible="false"
                                        CommandArgument='<%# Eval("noSPD") %>'
                                        Text="Complete" />
                                </ItemTemplate>
                            </asp:TemplateField>
            ...
            <div id="ClaimFinance" runat="server">
                <h3>List Approval Finance</h3>
                <p />
                Filter : &nbsp&nbsp&nbsp&nbsp
                <asp:DropDownList ID="DropDownListApprovalFinance" runat="server" Width="200px" OnSelectedIndexChanged="DropDownListApprovalFinance_SelectedIndexChanged" AutoPostBack="true">
                    <asp:ListItem Selected="True" Text="--Select--" Value="--Select--"></asp:ListItem>
                    <asp:ListItem Text="No SPD" Value="No"></asp:ListItem>
                    <asp:ListItem Text="Nama" Value="Nama"></asp:ListItem>
                    <asp:ListItem Text="BPH Claim" Value="BPHClaim"></asp:ListItem>
                    <asp:ListItem Text="Error BPH Claim" Value="ErrorBPHClaim"></asp:ListItem>
                    <asp:ListItem Text="Tanggal Berangkat" Value="TglBerangkat"></asp:ListItem>
                </asp:DropDownList>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox ID="txtCariApprovalFinance" runat="server" Visible="false"></asp:TextBox>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox
                    ID="txtTglBerangkatAwalApprovalFinance" runat="server"
                    AutoPostBack="True"
                    Width="200" Visible="false"></asp:TextBox>
                <ajax:CalendarExtender ID="CalendarExtender5" runat="server" TargetControlID="txtTglBerangkatAwalApprovalFinance">
                </ajax:CalendarExtender>
                &nbsp;&nbsp;&nbsp;&nbsp;
                <asp:TextBox
                    ID="txtTglBerangkatAkhirApprovalFinance" runat="server"
                    AutoPostBack="True"
                    Width="200" Visible="false"></asp:TextBox>
                <ajax:CalendarExtender ID="CalendarExtender6" runat="server" TargetControlID="txtTglBerangkatAkhirApprovalFinance">
                </ajax:CalendarExtender>
                <asp:Button ID="Button1" runat="server" Text="Search" OnClick="btnCariApprovalFinance_Click" />
                ...
                <div style="border: 1px solid #e3e3e3">
                    <asp:GridView ID="gvFinance" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Total" DataField="Total" />
                            <asp:BoundField HeaderText="Status" DataField="status" />
                            <asp:BoundField HeaderText="BPH Claim" DataField="BPHClaim" />
                            <asp:BoundField HeaderText="Error BPH Claim" DataField="ErrorBPHClaim" />
                             <asp:BoundField HeaderText="Bank Key" DataField="BankKey" />
                            <asp:BoundField HeaderText="Bank Account" DataField="BankAcount" />
