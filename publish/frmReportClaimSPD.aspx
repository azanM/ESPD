<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeBehind="frmReportClaimSPD.aspx.cs" Inherits="eSPD.frmReportClaimSPD" %>
...
<asp:Panel runat="server" ID="pnlView">
    ...
    <CR:CrystalReportSource ID="CrystalReportSource1" Report-FileName="~/crClaim.rpt" runat="server"  >
