<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmReportClaim.aspx.cs" Inherits="eSPD.frmReportClaim" MasterPageFile="~/MasterPage.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function popReport(noSPDClaim) {
            window.open('http://trac54/ReportServer/Pages/ReportViewer.aspx?/ReportSPD1/reportClaimPerItem&rs:Command=Render&rc:Parameters=false&noSPDClaim=' + noSPDClaim, "", disp_setting);
